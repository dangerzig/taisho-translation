...
**Compiled by:** Fajing (法經) and others, Sui dynasty (594 CE)
**Fascicles:** 7

*Note: This is a comprehensive bibliographic catalog of Buddhist scriptures compiled at the Daxingshan Temple (大興善寺) in the capital, by imperial order of the Sui dynasty court. It organizes the entire Chinese Buddhist canon into nine major divisions, each subdivided into six categories: single translations (一譯 yīyì), variant translations (異譯 yìyì), lost-translator texts (失譯 shīyì), excerpts (別生 biéshēng), suspicious texts (疑惑 yíhuò), and spurious/forged texts (偽妄 wěiwàng). The catalog totals 2,257 texts in 5,310 fascicles. The concluding fascicle contains a memorial to the Emperor dated to the fourteenth year of Kaihuang (開皇 Kāihuáng, 594 CE), with a historical survey of Buddhism's transmission to China.*
...
#### Section One: Single Translations
...
A combined total of 100 texts in 270 fascicles.
...
A combined total of 341 texts in 346 fascicles.
...
### Division Three: Mahayana Vinaya Collection (大乘毘尼藏錄)

A combined total of 48 texts in 82 fascicles.

**Single Translations:** 12 texts in 32 fascicles. The above 12 vinaya texts are all single-translation definitive editions.

**Variant Translations:** 7 texts in 7 fascicles. [Pairs identified as same-original variant translations of precept texts and observance texts.] The preceding 7 vinaya texts are all variant translations.
...
**Spurious Texts:** 2 texts in 11 fascicles.

### Division Four: Hinayana Vinaya Collection (小乘毘尼藏錄)

A combined total of 64 texts in 382 fascicles.

**Single Translations:** 16 texts in 199 fascicles.

**Variant Translations:** 8 texts in 126 fascicles. [Four pairs of same-original variant translations.]

**Lost-Translator Texts:** 29 texts in 45 fascicles.

**Excerpted Texts:** 6 texts in 6 fascicles.

**Suspicious Texts:** 2 texts in 3 fascicles.

**Spurious Texts:** 3 texts in 3 fascicles.

### Division Five: Mahayana Abhidharma Collection (大乘阿毘曇藏錄)

A combined total of 68 texts in 282 fascicles.

**Single Translations:** 42 texts in 207 fascicles.

**Variant Translations:** 8 texts in 52 fascicles. [Four pairs of same-original variant translations.]
...
**Spurious Texts:** 1 text in 1 fascicle. A human fabrication.

### Division Six: Hinayana Abhidharma Collection (小乘阿毘曇藏錄)

A combined total of 116 texts in 489 fascicles.

**Single Translations:** 14 texts in 276 fascicles.

**Variant Translations:** 8 texts in 66 fascicles. [Two pairs and one group of four, all same-original variant translations.]

**Lost-Translator Texts:** 5 texts in 22 fascicles.

**Excerpted Texts:** 86 texts in 107 fascicles. [75 texts extracted from the *Dharmapada-avadāna* (出曜論 *Chūyào lùn*), plus 11 miscellaneous treatise excerpts.]

**Suspicious Texts:** 1 text in 1 fascicle.

**Spurious Texts:** 2 texts in 10 fascicles. Human fabrications.
...
A combined total of 50 texts in 122 fascicles.

Of these, 21 texts are Mahayana compilations. The remaining 29 are Hinayana compilations. All 50 texts are Western [Indian] compilations.

#### Part Two: Compiled by Chinese Scholars

[97 texts compiled by Chinese scholars, including:]

14 texts are Three-Basket compilations.

37 texts are excerpts from the *Ṣaṭpāramitā-saṃgraha* (六度集 *Liùdù jí*).

2 texts are separate excerpts from the *Avadāna-śataka* (百緣經 *Bǎiyuán jīng*).

1 text is a separate excerpt from the *Dharmapada-avadāna* (法句喻經 *Fǎjù yù jīng*).

42 texts are excerpts from various *avadāna* and parable collections (雜譬喻集 *Zá pìyù jí*).
...
#### Part One: Western Sages' Biographies

13 texts in 30 fascicles. All written by Western [Indian] sages.

#### Part Two: Chinese Scholars' Biographies

[55 texts total, consisting of:]
...
The preceding 15 prefaces, commentaries, and treatises are all compositions by Western [Indian] sages.
...
## Fascicle Seven: General Catalog (眾經總錄)
...
Today, we, Fajing and the others, in knowledge and learning admittedly do not match the ancients. Yet through fortunate karmic connections, we have the good fortune to live in an auspicious age. The four seas are unified as one family, all within the six directions is peaceful and tranquil. Distant lands and foreign customs are as if right before our eyes. Wherever the imperial calendar extends, there is no region outside its reach. Moreover, the Emperor, our Great Patron, though personally attending to the myriad affairs of state, delights in the Way throughout the day, reviving the Three Jewels as a Dharma-Wheel-Turning King. He has permanently closed the gates to the four evil destinies and broadly opened the path to the heavenly and human realms. All living beings within his domain benefit from his grace, how much more so we ourselves! What more need be said? Our only regret is that our knowledge and wisdom are limited, and though we have been unworthily included in this auspicious endeavor, we have not been able to obtain all the scriptural texts from the three regions, nor track down every lost text and scattered teaching. Our hastily compiled work contains many inadequacies. Looking forward and reflecting back, our shame and regret run deep.

Respectfully submitted on the fourteenth day of the seventh month of the fourteenth year of Kaihuang [594 CE], by the monks of the Translation Bureau at Daxingshan Temple, led by Fajing and others.
