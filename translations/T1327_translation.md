# 佛說呪齒經
## Scripture on the Spell for Teeth, Spoken by the Buddha
...
- **[Name]**: The Chinese uses 某 (*mǒu*), a placeholder where the practitioner would insert the patient's name.
- **Gandhamahāyana Mountain** (健陀摩呵衍山): A phonetic transcription; likely a variant of Gandhamādana, the mythic northern mountain.
- **Chāhōumu** (差吼無): Phonetic transcription of an unidentified Sanskrit or Prākrit demon-king name.
- **The vessel**: A container into which expelled worms would fall, used in ritual dental treatments.
- **Jūluóqínshàn** (鳩羅勤蟮): Phonetic transcription followed by 蟮 (*shàn*, "earthworm"); the full term is unidentified but functions as a stock simile in the standard threat formula of Chinese dhāraṇī texts, where malevolent beings are threatened with their heads splitting into seven pieces.
